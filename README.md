...
| [`Docs/`](Docs/Starfield-Handle-Cap-Raise.md) | Technical background on the Creation Engine handle limit and a detailed analysis of [how the Starfield plugin raises it](Docs/Starfield-Handle-Cap-Raise.md). |
